app.controller('HairRatingController', ['$scope', '$http', '$location', 'ReviewService', function($scope, $http, $location, ReviewService){
  ...
  $scope.putAndGoMap = function(){
    var contentToSend = {regisId: $scope.currentReviewEmpInfo.RegisId, SectionId: 4, SubsectionId: 1, data: {EmployeeHairRating: $scope.hairRatingData[10].EmployeeHairRating, LeaderHairRating: $scope.hairRatingData[10].LeaderHairRating}};
